<template>
    <div class="container">
        ...
        <div class="main layoutWrap clearfix" style="min-height: 76px;">
           <template>
                <Breadcrumb firstName="首页" secondName="我的商报" firstLink="/" secondLink='/index/myshangbao' thirdName="编辑商报"></Breadcrumb>
            </template>
        </div>
        <div class="page-contain">
             <div class="page-limit">
                 <div class="pageWrap">
                    <h2 class="title">编辑商报</h2>
...
<script>
    ...
    import WangEditor from 'wangeditor' //引入富文本编辑器
     import {richTextFileUpload,newsUpdate,newsAndavenuesDetail} from '@/api/api'
    export default {
        data() {
            return {
                name: 'editor',
        ...
        methods: {
            ...
            newsAndavenuesDetail() {
                ...
                newsAndavenuesDetail(data).then(res => {
                    if (res.code === 200) {
