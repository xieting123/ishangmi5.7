    ...
    <div class="container">
      <div class="MemberContain">
        <div class="MemberCard">
          ...
          <br>
          <span class="ID common">{{memberProfile.age}}岁 | {{memberProfile.provinceName}} | ID:{{memberProfile.id}}</span>
          <br>
          <div class="obtns">
<button class='follow'>
    ...
    <router-link v-else class="linkTo" :to="{ name: 'MemberService', query: {userId:memberProfile.id}}">TA的主页</router-link>
        ...
        <div class="Show">
          ...
          <div class="cartWay">
              <span>工作地: {{mateSelection.user.provinceName}} {{mateSelection.user.cityName}}</span>
                    <span>身高：{{mateSelection.height}}cm</span>
                    <span>体重：{{mateSelection.weight}}kg</span>
                    <span>月收入: {{mateSelection.monthIncome}}</span>
                    <span>{{mateSelection.education}}</span>
                    <span>{{mateSelection.maritalStatus}}</span>
                    <span>是否想要小孩：{{mateSelection.wantChild}}</span>
                    <span>{{mateSelection.haveChild}}</span>
                    <span>{{mateSelection.smoke}}</span>
                    <span>{{mateSelection.drink}}</span>
          ...
          <div class="workExperience">
            ...
            <div class="work">
                <ul>
                    <li class="test">喜欢的活动: {{mateSelection.activity?mateSelection.activity:'未填写'}}</li>
                    <li class="test">喜欢的食物: {{mateSelection.food?mateSelection.food:'未填写'}}</li>
                    <li class="test">喜欢的体育运动: {{mateSelection.sports?mateSelection.sports:'未填写'}}</li>
                    <li class="test">喜欢的地方: {{mateSelection.place?mateSelection.place:'未填写'}}</li>
                    <li class="test">喜欢的音乐: {{mateSelection.music?mateSelection.music:'未填写'}}</li>
                    <li class="test">喜欢的宠物: {{mateSelection.pet?mateSelection.pet:'未填写'}}</li>
                    <li class="test">喜欢的影视节目: {{mateSelection.video?mateSelection.video:'未填写'}}
                    </li>
                </ul>
          ...
          <div class="eduExperience">
            ...
            <div class="cartWay2">
                     <span>工作地: {{mateSelection.provinceName}} {{mateSelection.cityName}}</span>
                    <span>身高：{{mateSelection.mateHeight}}</span>
                    <span>体重：{{mateSelection.mateWeight}}</span>
                    <span>年龄: {{mateSelection.mateAge}}</span>
                    <span>月收入: {{mateSelection.mateMonthIncome}}</span>
                    <span>{{mateSelection.mateEduction}}</span>
                    <span>{{mateSelection.mateMaritalStatus}}</span>
                    <span>是否想要小孩： {{mateSelection.mateWantChild}}</span>
                    <span>{{mateSelection.mateHaveChild}}</span>
                    <span>{{mateSelection.mateSmoke}}</span>
                    <span>{{mateSelection.mateDrink}}</span>
            </div>
          </div>
        ...
        res => {
          if (res.code === 200) {
            if (res.result) {
              ...
              console.log( this.mateSelection,375);
