...
<script>
    ...
    export default {
        ...
        //从路由获取商会ID
        created: function() {
            this.skillData.type = this.$route.query.type;
            this.skillData.labelName = this.$route.query.labelName;
            this.skillData.icon = this.$route.query.icon;
            this.skillData.id = this.$route.query.id;
        },
        mounted() {
