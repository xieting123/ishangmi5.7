                    ...
                    <li class="business-road ">
                       <div class="clearfix">
                            <div class="head-info lt">
                                <router-link v-if='baseData.user.userIdentity.identityId===4' class="linkTo" :to="{ name: 'businessmanmemberPersonCenter', query: {userId:baseData.userId}}">
                                    <img :src="baseData.user.avatar" class="head-info-img defaultHead_Portrait_pic"/>
                                </router-link>
                                <router-link v-else class="linkTo" :to="{ name: 'MemberService', query: {userId:baseData.userId}}">
                                    <img :src="baseData.user.avatar" class="head-info-img defaultHead_Portrait_pic"/>
                                </router-link>
